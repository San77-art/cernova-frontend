...
async function POST(req) {
    try {
        ...
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])("SELECT id, email, name, password FROM users WHERE email = $1", [
            email
        ]);
        if (!user) {
            return Response.json({
        ...
        const isPasswordValid = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$bcrypt$29$__["default"].compare(password, user.password);
        if (!isPasswordValid) {
            return Response.json({
                error: "Credenciais invalidas"
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0b876_l._.js.map