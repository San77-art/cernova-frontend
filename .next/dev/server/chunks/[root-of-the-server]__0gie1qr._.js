...
async function POST(req) {
    try {
        ...
        // Verificar se existe
        const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])("SELECT id FROM users WHERE email = $1", [
            email
        ]);
        if (existing) {
            return Response.json({
        ...
        // Inserir no banco
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("INSERT INTO users (id, email, password, name) VALUES ($1, $2, $3, $4)", [
            userId,
            email,
            hashedPassword,
            name || email.split("@")[0]
        ]);
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateJWT"])(userId);
        return Response.json({
            success: true,
            token,
            user: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0gie1qr._.js.map