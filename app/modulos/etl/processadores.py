# app/modulos/etl/processadores.py

from typing import Dict, Any
from app.modulos.etl.interfaces import ProcessadorNota

# ============================================================================
# PROCESSADOR 1: NF-e (Nota Fiscal Eletrônica)
# ============================================================================
...
class ProcessadorNFe(ProcessadorNota):
    ...
    def inserir_no_rb(self, dados: Dict) -> int:
        """Insere dados no Registro de Bloco da NF-e"""
...
# ============================================================================
# PROCESSADOR 2: NFC-e (Nota Fiscal de Consumidor Eletrônica)
# ============================================================================
...
class ProcessadorNFCe(ProcessadorNota):
    ...
    def validar_assinatura(self, xml: str) -> bool:
        """Valida assinatura digital de NFC-e"""
        print(f"Validando assinatura NFC-e...")
        return True
    
    def extrair_dados(self, xml: str) -> Dict[str, Any]:
        """Extrai dados estruturados do XML da NFC-e"""
    ...
    def inserir_no_rb(self, dados: Dict) -> int:
        """Insere dados no Registro de Bloco da NFC-e"""
...
# ============================================================================
# PROCESSADOR 3: CT-e (Conhecimento de Transporte Eletrônico)
# ============================================================================
...
class ProcessadorCTe(ProcessadorNota):
    ...
    def validar_assinatura(self, xml: str) -> bool:
        """Valida assinatura digital de CT-e"""
        print(f"Validando assinatura CT-e...")
        return True
    
    def extrair_dados(self, xml: str) -> Dict[str, Any]:
        """Extrai dados estruturados do XML do CT-e"""
    ...
    def inserir_no_rb(self, dados: Dict) -> int:
        """Insere dados no Registro de Bloco do CT-e"""
